/* Multipuls v3.4. Bump VERSION and script/style URL versions for every release. */
"use strict";
const VERSION = "v3.4";
...
const ASSETS = [
  "./index.html", "./styles.css?v=3.4", "./storage.js?v=3.4", "./app.js?v=3.4",
  "./share.js?v=3.4", "./pwa.js?v=3.4", "./manifest.webmanifest?v=3.4",
